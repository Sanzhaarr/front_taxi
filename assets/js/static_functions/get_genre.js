            ...
            for (let item in items) {
                const data_for_print = `
                    <div class="game_genres_to_create_label">
                        <input id="${items[item].id_of_genre}" class="game_genres_to_create" type="checkbox" placeholder="${items[item].genre}" name="${items[item].genre.toLowerCase()}" value="${items[item].genre}">
